...
var swiper = new Swiper(".testimonials__items", {
  cssMode: true,
  navigation: {
...
document.querySelectorAll(".media").forEach(block => {
  const buttons = block.querySelectorAll(".filter-btn");
  const cards = block.querySelectorAll(".media__card");
  const modal = document.getElementById("mediaModal");
  const modalBody = modal.querySelector(".media-modal__body");
...
var swiper = new Swiper(".media__slider", {
  ...
  breakpoints: {
    ...
    // от 400 до 899 — 2 слайда
    600: {
      slidesPerView: 2,
      spaceBetween: 20
    },
    // от 900 и выше — 3 слайда
    900: {
      slidesPerView: 3,
      spaceBetween: 30
    }
...
const programTabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_1__["default"]('program-tabs');

// Второй набор табов
const galleryTabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_1__["default"]('programs-tabs');
(function () {
  const input = document.getElementById('files-upload');
  const list = document.querySelector('.contacts__upload-list');
  ...
  input.addEventListener('change', function () {
    ...
    files.forEach(f => {
      ...
      el.className = 'contacts__upload-file';
  ...
  // keyboard accessibility: нажать Enter/Space на label тоже откроет диалог (по умолчанию работает),
  // если нужно — можно добавить обработчик клавиш.
})();
document.addEventListener("DOMContentLoaded", function () {
  document.querySelectorAll("[data-select]").forEach(select => {
    const trigger = select.querySelector("[data-select-trigger]");
    const options = select.querySelector(".form__custom-options");
